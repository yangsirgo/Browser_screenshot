//(function () {
var box =document.querySelectorAll('.canvas_con')[0];
var style = window.getComputedStyle ? window.getComputedStyle(box,null) : null || box.currentStyle;
var divcanvas_width = parseInt(style.width);
var divcanvas_height = parseInt(style.height);
var rat = divcanvas_width/window.innerWidth;
	var paint = {
		init: function () {
			this.load();
		},
...
//				};
			...
			this.canvas['on' + t.StartEvent] = function (e) {
				...
				var _x = touch.clientX - touch.target.offsetLeft-touch.target.parentNode.offsetLeft;//鼠标在画布上的x坐标，以画布左上角为起点
				var _y = touch.clientY - touch.target.offsetTop-touch.target.parentNode.offsetTop;//鼠标在画布上的y坐标，以画布左上角为起点
				if (t.isEraser) {
					/*
